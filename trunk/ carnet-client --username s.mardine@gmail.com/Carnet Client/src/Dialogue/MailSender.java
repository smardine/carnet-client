...
import smtp.SendMailUsingAuthentication;
...
public class MailSender extends JFileChooser
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7996209837525302785L;
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        SendMailUsingAuthenticationWithAttachement mailUsingAuthentication =
                new SendMailUsingAuthenticationWithAttachement();
        try {
